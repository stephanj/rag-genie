...
@Component({
  selector: 'genie-authenticated-layout',
  templateUrl: './genie-authenticated-layout.component.html'
})
export class GenieAuthenticatedLayoutComponent implements OnDestroy {
