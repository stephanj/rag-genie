...
export class JhiFilterPipe implements PipeTransform {
    ...
    private filterByNumber(filter: any, field?: any) {
        return(value: any) =>
    ...
    private filterByBoolean(filter: any, field?: any) {
        return(value: any) =>
    ...
    private filterByString(filter: any, field?: any) {
        return (value: any) =>
            (value && !filter) || (typeof value === 'object' && field)
    ...
    private filterDefault(filter: any, field?: any) {
