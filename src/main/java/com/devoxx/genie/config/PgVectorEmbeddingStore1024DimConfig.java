...
import com.devoxx.genie.service.embedding.PgVectorEmbeddingStore1024Dim;
...
@Configuration
public class PgVectorEmbeddingStore1024DimConfig {

    @Bean(name = "dbEmbeddingStore1024")
    public EmbeddingStore<TextSegment> dbEmbeddingStore(@Value("${genie.database.name}") String dbName,
        ...
        return new PgVectorEmbeddingStore1024Dim(dbHost,
            dbPort,
            dbUser,
            dbPassword,
            dbName,
