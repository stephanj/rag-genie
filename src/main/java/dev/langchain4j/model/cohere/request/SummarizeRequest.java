...
public class SummarizeRequest {
    ...
    /**
     * The text to generate a summary for. Can be up to 100,000 characters long.
     ...
     * If auto is selected, the best option will be picked based on the input text.
     * Default: medium
     */
    String length;
    ...
    /**
     * The identifier of the model to generate the summary with. Currently available models are command (default),
     ...
     * High extractiveness summaries will lean towards reusing sentences verbatim, while low extractiveness summaries
     * will tend to paraphrase more. If auto is selected, the best option will be picked based on the input text.
     * Default: low
     */
    ...
    /**
     * A free-form instruction for modifying how the summaries get generated. Should complete the sentence
     * "Generate a summary _". Eg. "focusing on the next steps" or "written by Yoda"
     */
